...
?>
<section
    class="mod-hc-igpulse mod-hc-igpulse--mosaic"
    id="<?php echo $moduleId; ?>"
    data-hc-ratio="<?php echo htmlspecialchars($aspectRatio, ENT_QUOTES, 'UTF-8'); ?>"
    style="--hc-igpulse-cols-desktop:<?php echo $colsDesktop; ?>;--hc-igpulse-cols-mobile:<?php echo $colsMobile; ?>;<?php echo $gapEnabled ? '--hc-igpulse-gap:' . $gapSize . 'px' : '--hc-igpulse-gap:0px'; ?>"
    aria-label="<?php echo Text::_('MOD_HC_IGPULSE_ARIA_FEED'); ?>"
>
    <ul class="hc-igpulse-mosaic" role="list">
        <?php foreach ($items as $index => $item) :
            ...
            $isFeatured = ($index === 0) ? ' hc-igpulse-item--featured' : '';
        ?>
        <li class="hc-igpulse-item<?php echo $isFeatured; ?>" role="listitem">
